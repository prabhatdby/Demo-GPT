  ...
  return (
    <div className="container">
      ...
      <section className="main">
        ...
        <svg onClick={() => setToggled(!toggled)} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="burger" height="28.8" width="28.8" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M24 0v24H0V0h24z" opacity=".87"></path><path d="m14 7-5 5 5 5V7z"></path></svg>
